...
export async function GET() {
  ...
  const url = toAbsoluteUrl(backendBaseUrl, "/factus/health");
  ...
  try {
    ...
    return NextResponse.json(
      {
        message:
          "No se pudo conectar con el backend para validar Factus. Verifica que Uvicorn esté corriendo.",
