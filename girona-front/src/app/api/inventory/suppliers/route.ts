...
export async function GET() {
  ...
  const url = toAbsoluteUrl(backendBaseUrl, "/inventory/suppliers");
  ...
  try {
    ...
    return NextResponse.json(
      {
        message:
          "No se pudo conectar con el backend para cargar proveedores. Verifica que Uvicorn este corriendo y que `BACKEND_URL` sea accesible desde el servidor de Next.js.",
