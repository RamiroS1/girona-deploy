...
export async function POST(
  ...
  const url = toAbsoluteUrl(backendBaseUrl, `/pos/orders/${orderId}/deliver`);
  ...
  try {
    ...
    return NextResponse.json(
      {
        message:
          "No se pudo conectar con el backend para marcar la orden como entregada. Verifica que Uvicorn esté corriendo y que `BACKEND_URL` sea accesible desde el servidor de Next.js.",
